...
public class ModItems {
    ...
    public static final DeferredItem<SwordItem> AMETHYST_SWORD = ITEMS.register("amethyst_sword", AmethystSwordItem::new);
    public static final DeferredItem<ShovelItem> AMETHYST_SHOVEL = ITEMS.register("amethyst_shovel", AmethystShovelItem::new);
    ...
    // 回响工具
    public static final DeferredItem<SwordItem> ECHO_SWORD = ITEMS.register("echo_sword", EchoSwordItem::new);
    public static final DeferredItem<ShovelItem> ECHO_SHOVEL = ITEMS.register("echo_shovel", EchoShovelItem::new);
